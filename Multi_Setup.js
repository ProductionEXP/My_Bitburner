...
export async function main(ns) {
	...
	const server = ns.args[6];                                                                            

	const ram_s = ns.getServerMaxRam(server) - ns.getServerUsedRam(server);								    
	const ram_1 = ns.getScriptRam("Full_V2.js") * 30;                                                       
	const ram_2 = ns.getScriptRam("Grow_V2.js") * 30;                                                         
	const ram_3 = ns.getScriptRam("Weaken_V2.js") * 30;
	...
	if (ram_f > 0) {                                                                                    
		...
		s.exec("Full_V2.js", server, 5, target2);                                                 		
		...
		s.exec("Full_V2.js", server, 5, target3);                                                 		
		...
		s.exec("Full_V2.js", server, 5, target4);                                                 		
		...
		s.exec("Full_V2.js", server, 5, target5);                                                 		
		...
		s.exec("Full_V2.js", server, 5, target6);                                                 		
